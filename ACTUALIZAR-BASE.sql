...
-- =====================================================================
--
-- QUE TRAE: los dos bloques nuevos.
--
...
-- instalo la base, este archivo encima, y se corrieron los 157 ataques —
-- incluidos el doble clic en "Finalizar venta", dos cajas vendiendo la ultima
-- pieza a la vez, y un pago mixto que tiene que dejar dos movimientos de caja.
--
-- =====================================================================
...
-- necesitan Productos y Ventas: el inventario deja rastro, el cobro pasa
-- entero o no pasa, y un doble clic no cobra dos veces.
-- =====================================================================
